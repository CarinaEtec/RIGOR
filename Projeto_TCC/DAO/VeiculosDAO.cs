...
namespace Projeto_TCC.DAO
{
    class VeiculosDAO
    {
        ...
        public void Insert(Veiculos veiculos) //Inserir
        {
            try
            {
        ...
        public void Delete(Veiculos veiculos) //Deletar
        {
            try
            {
                MySqlCommand comando = new MySqlCommand();
        ...
        public void Update(Veiculos veiculos) //Editar
        {
            try
            {
                MySqlCommand comando = new MySqlCommand();
        ...
        public DataTable BuscaApto(string apto) //Busca por apto
        {
        ...
        public DataTable BuscaBloco(string bloco) //Busca por bloco
        {
            MySqlConnection con = ConexaoBanco.Conectar();
            MySqlCommand comando = new MySqlCommand();
            comando.CommandType = CommandType.Text;
        ...
        public DataTable BuscaPlaca(string placa) //Busca pela placa
        {
            MySqlConnection con = ConexaoBanco.Conectar();
            MySqlCommand comando = new MySqlCommand();
            comando.CommandType = CommandType.Text;
