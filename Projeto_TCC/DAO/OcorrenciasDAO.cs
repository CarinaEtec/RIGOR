...
namespace Projeto_TCC.DAO
{
    ...
    {
        public void Insert(Ocorrencias ocorrencias) //Inserir
        {
            try
            {
        ...
        public void Update(Ocorrencias ocorrencias) //Editar
        {
            try
            {
                MySqlCommand comando = new MySqlCommand();
        ...
        public DataTable BuscaApto(string apto) //Buscar pelo apto
        {
